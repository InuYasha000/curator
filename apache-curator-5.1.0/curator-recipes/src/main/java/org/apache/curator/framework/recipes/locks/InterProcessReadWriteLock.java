    ...
    */
    ...
    private PredicateResults readLockPredicate(List<String> children, String sequenceNodeName) throws Exception
    {
        ...
        for ( String node : children )
        {
            ...
            {
                //这里其实就是设置成了0，下面则因为index++，最后一定会 ourIndex > firstWriteIndex ，所以加锁失败（写+读）
        ...
        //在这里比较看出来 firstWriteIndex 默认是 Integer.MAX_VALUE （除非前面是写锁），也就是读读情况下最多 Integer.MAX_VALUE 个客户端获取锁，也就是读读不互斥
